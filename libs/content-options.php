...
<h3><?php _e('EasyWay Online Ordering Design Options', 'easyway_tr' ) ?></h3>
...
<li>In the plugin settings, enter your restaurant slug.  Your restaurant slug is the portion of your Site URL immediately following “easywayordering.com” </li>
    ...
    <div class="postbox">
     <h3>Help finding your slug</h3>
      <div class="inside" style="font-size: 11px;margin: 6px 2px 6px 2px;">
        ...
        <br> 
        <br>
        <img src="<?php echo PLUGIN_URL; ?>/images/punta-cana.png" border='0'>
        <br>

 <br>
        In this example the site URL is <span style="color:#006;font-style:italic;text-decoration:underline;">http://www.easywayordering.com/punta_cana/</span> and the slug is “punta_cana” <br> <br>
  ...
  <p>Powered by <a href='http://www.vcita.com/?invite=VR_PB-424205'>vCita</a></p>
	...
	<div id="post-body">
		<div id="post-body-content">
			<form name="easyway_form" id="easyway_form" method="post" action="<?php echo FORM_ACTION; ?>" enctype="multipart/form-data">
                ...
                ?>
                <p class="submit">
                    <input type="submit" name="Submit" value="<?php _e('Update Options', 'easyway_tr' ) ?>" class="button-primary" />
                    <input name="reset" type="submit" id="reset_template_button" value="Restore default settings" />
                    <input type="hidden" name="action" value="save" id="easyway_form_action" />
                </p>
		    </form>
	    </div>
    </div>
