...
<h3><?php _e('Support / FAQ', 'easyway_tr' ) ?></h3>
	...
	<div id="post-body">
        ...
        <div class="postbox">
           ...
           <ul style='list-style:inside;margin-left:20px;'>
           	<li><a href='http://www.easywayordering.net' target='_blank'>Sign up for your free 30 day trial  </a></li>
                <li>	Give us your menu so we can build your online store</li>
                <li>	Schedule a training & orientation (optional)</li>
                <li>	Add the plugin and start receiving orders</li>
                </ul>
         ...
         <div class="postbox">
		   ...
		   <div class="inside">
           <div class="info">
           <strong>How much does it cost to download the plugin?</strong><br>
...
<br>
 <div class="info">
<strong>How much does it cost to receive orders?</strong><br>
There are no upfront fees for the restaurant. Setup and maintenance is on us. The first 30 days are free. After that the restaurant will pay a monthly service fee. There are no hidden fees and no contracts to sign. You can find more details about our pricing.
</div>
<br>
 <div class="info">
<strong>Does the restaurant need to sign a contract to use your service?
</strong><br>There are no binding contracts to use our service. It is a pay as you go model. There are no cancellation penalties etc. You do need to sign up and agree to do business with us for us to configure and host the restaurant menu.
</div>
<br>
 <div class="info">
<strong>How will restaurant receive orders placed from their website?
</strong><br>The restaurant will receive the orders via fax, email or on their POS screen. For maximum reliability, an automated confirmation phone call is placed to the restaurant to ensure no order slips through the cracks.
</div>
<br>
 <div class="info">
<strong>How will the restaurant get paid for their orders?
</strong><br>EasyWay Ordering works with the restaurants own merchant account so customers who are paying by credit card will be paying the restaurant directly and their statement will reflect the name of the restaurant not EasyWay Ordering.
</div>
<br>
 <div class="info">
<strong>How long does it take to get started?
</strong><br>It just takes 15 minutes to create your restaurant account using the quick start wizard. Once you’ve completed your registration and uploaded or faxed in your menu, our menu design department will take over from there and your online ordering will be ready to use in 2 to 3 days.
</div>

<br>
 <div class="info">
<strong>Can the restaurant sell beer and wine online?</strong><br>
